...
type InputElementBuilder<'t when 't :> InputElement>() =
    ...
    member _.onLostFocus<'t>(x: IAttr<'t> list, func: RoutedEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onKeyDown<'t>(x: IAttr<'t> list, func: KeyEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onKeyUp<'t>(x: IAttr<'t> list, func: KeyEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onTextInput<'t>(x: IAttr<'t> list, func: TextInputEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerEnter<'t>(x: IAttr<'t> list, func: PointerEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerLeave<'t>(x: IAttr<'t> list, func: PointerEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerMoved<'t>(x: IAttr<'t> list, func: PointerEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerPressed<'t>(x: IAttr<'t> list, func: PointerPressedEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerReleased<'t>(x: IAttr<'t> list, func: PointerReleasedEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerCaptureLost<'t>(x: IAttr<'t> list, func: PointerCaptureLostEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onPointerWheelChanged<'t>(x: IAttr<'t> list, func: PointerWheelEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onTapped<'t>(x: IAttr<'t> list, func: RoutedEventArgs -> unit, ?subPatchOptions) =
    ...
    member _.onDoubleTapped<'t>(x: IAttr<'t> list, func: RoutedEventArgs -> unit, ?subPatchOptions) =
