...
module ButtonSpinner =
    ...
    let create (attrs: IAttr<ButtonSpinner> list): IView<ButtonSpinner> =
    ...
    type ButtonSpinner with
        ...
        /// </summary>
        static member allowSpin<'t when 't :> ButtonSpinner>(value: bool) =
        ...
        /// </summary>
        static member showButtonSpinner<'t when 't :> ButtonSpinner>(value: bool) =
        ...
        /// </summary>
        static member buttonSpinnerLocation<'t when 't :> ButtonSpinner>(value: Location) =
